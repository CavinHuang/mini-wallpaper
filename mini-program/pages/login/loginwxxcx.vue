<template>
	<view class="content">
		...
		<view style="margin-top: 50px;">
			<button class="button-login1" v-if="dltel==1" open-type="getPhoneNumber"
				style="font-size: 26upx; color: #ffffff;" @getphonenumber="onGetPhoneNumber">登录</button>
			<button class="button-login1" v-else @click="Loginops()"
				style="font-size: 26upx; color: #ffffff;">登录</button>
		</view>
		<!-- #endif -->
	</view>
</template>
									...
									if (cts.data.data.userinfo.avatar) {
										...
										if (str.indexOf("data:image") != -1) {
											...
											if (str.indexOf("http") != -1) {
												...
												avatar = this.configs.imgUrl + cts.data.data
													.userinfo.avatar;
											}
										}
									} else {
