      ...
      if (!slots.default) {
        children.default = () => {
            ...
            return h(
              ...
              {},
              {
                default: () => [
                  ...
                  h('div', { staticClass: 'el-upload__text' }, { default: () => [curProps.textContent] })
                ]
              }
            )
          }
          ...
          return h(
            ...
            {},
            {
              default: () => [h(UploadIcon, { style: { width: '12px', height: '12px' } }), curProps.textContent]
            }
          )
        }
      }
      console.log('======', { ...props, ...attrs })
      return h(ElUpload as any, { ...props, ...attrs, ...{ fileList: curProps.fileList } }, children)
    }
  }
})
