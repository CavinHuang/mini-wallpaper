...
function colorGradient(startColor = 'rgb(0, 0, 0)', endColor='rgb(255, 255, 255)', step = 10) {
  ...
  let startR = startRGB[0] as number
  let startG = startRGB[1] as number
  let startB = startRGB[2] as number
  
  let endRGB = hexToRGB(endColor, false)
  let endR = endRGB[0] as number
  let endG = endRGB[1] as number
  let endB = endRGB[2] as number
 ...
 */
function hexToRGB(color: string, str = true) {
 ...
 */
function colorToRGBA(color: string, alpha = 0.3) {
